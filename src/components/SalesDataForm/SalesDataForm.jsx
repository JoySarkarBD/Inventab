    ...
    return (
        <form>
                <div className='row'>
                  ...
                  <label className='mb-2 text-dark text-capitalize'>Department
                  </label>
                  ...
                  {/* add sub org input */}
                  <div className='mb-3 col-md-6'>
                  <label className='mb-2 text-dark text-capitalize'>Sub org
                  </label>
                  ...
                  <div className='mb-3 col-md-6'>
                    <label className='mb-2 text-dark text-capitalize'>Probability
                  </label>
                  ...
                  {/* add status input */}
                  <div className='mb-3 col-md-6'>
                  <label className='mb-2 text-dark text-capitalize'>Status*
                  </label>
                  ...
                  <div className='mb-3 col-md-6'>
                   ...
                   <div className='mb-3 col-md-6'>
                   <label className='mb-2 text-dark text-capitalize'>Contact Name
                  </label>
                    ...
                    return (
                          <tr  key={table.id} >
                            <td>
                              ...
                              <Select className="select" options={options} placeholder="Select Port No"/>
                              
                              </div>
                              </td>
                            <td>
                              <input className="new_input_class" type='number' placeholder="Unit Cost"/>
                            </td>
                            <td>
                              <input className="new_input_class" type='number'  placeholder="Total Quntity"/>
                            </td>
                            <td>
                              <input className="new_input_class" type='number'placeholder="Extd Net Cost"/>
                            </td>
                            <td>
                              <input className="new_input_class" type='number' placeholder="Extd Gross Cost"/>
                            </td>
                            <td>
                              <button className="btn btn-danger btn-sm" onClick={() => handleRemove(table.id)}>Remove</button>
                            </td>
                          </tr>
                    );})
                  }
                ...
                {/* Submit Button */}
                <div className='d-flex justify-content-end my-4'>
                <input className="btn btn-primary" type="submit" value="Add Sales Lead" />
                </div>
              </form>
    )
}